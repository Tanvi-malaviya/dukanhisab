...
@section('content')
    <div class="space-y-4">
        ...
        <!-- Top Bar with Gateway Settings Link -->
        <div class="flex items-center justify-between">
            <h2 class="text-base font-bold text-white">Platform Revenue & Transactions</h2>
            <a href="{{ route('admin.settings.payment') }}"
                class="px-3.5 py-2 rounded-xl text-xs font-semibold bg-primary hover:bg-primary/90 text-white transition-all flex items-center gap-2 shadow-sm">
                ...
                <span>Configure Razorpay Credentials</span>
            </a>
        </div>
