            ...
            <div class="flex items-center gap-3.5 min-w-0">
                ...
                <div class="space-y-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        @if($user->activePlan)
                            <span
                                class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold {{ $user->activePlan->slug !== 'free' ? 'bg-amber-50 text-amber-700 border border-amber-200' : 'bg-slate-100 text-slate-700 border border-slate-200' }}">
