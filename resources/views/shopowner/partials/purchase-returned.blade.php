    ...
    <div class="space-y-4">
        ...
        <template x-if="purchasesLoading">
            <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-sm text-center">
                ...
                <p class="text-xs text-slate-400 mt-2 font-medium" x-text="t('loading')">Loading returned purchases...</p>
            </div>
        </template>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700 shadow-sm p-3.5 hover:shadow-md transition-all flex flex-col justify-between space-y-3">
                    ...
                    <div class="space-y-1 text-[11px] py-1.5 border-t border-slate-100 dark:border-gray-700/50">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-slate-700 dark:text-slate-300 font-mono" x-text="formatDate(pur.purchase_date)"></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-slate-400 font-sans" x-text="t('payment_type') + ':'">Payment:</span>
                            <span class="text-slate-700 dark:text-slate-300 font-medium font-sans" x-text="t(pur.payment_type ? pur.payment_type.toLowerCase() : '') || pur.payment_type"></span>
                        </div>
                    </div>
