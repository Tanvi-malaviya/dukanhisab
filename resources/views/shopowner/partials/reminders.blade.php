...
<div x-show="page === 'reminders'" class="space-y-6">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div
            ...
            <div>
                <div class="flex justify-between items-center mb-3">
                    <h4 class="text-xs sm:text-sm font-extrabold text-slate-800 dark:text-slate-200 truncate">Customer Dues (Outstanding)</h4>
                    ...
                    <table class="w-full divide-y divide-slate-200 dark:divide-gray-700">
                        <thead>
                            <tr class="bg-slate-50 dark:bg-gray-700/50">
                                <th class="px-2.5 py-2 text-left text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Customer</th>
                                <th class="px-2.5 py-2 text-left text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Mobile</th>
                                <th class="px-2.5 py-2 text-left text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Due</th>
                                <th class="px-2.5 py-2 text-right text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Actions</th>
                            </tr>
                        </thead>
        ...
        <div
            ...
            <div>
                <div class="flex justify-between items-center mb-3">
                    <h4 class="text-xs sm:text-sm font-extrabold text-slate-800 dark:text-slate-200 truncate">Supplier Dues (We Owe)</h4>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full divide-y divide-slate-200 dark:divide-gray-700">
                        <thead>
                            <tr class="bg-slate-50 dark:bg-gray-700/50">
                                <th class="px-2.5 py-2 text-left text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Supplier</th>
                                <th class="px-2.5 py-2 text-left text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Mobile</th>
                                <th class="px-2.5 py-2 text-left text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Due</th>
                                <th class="px-2.5 py-2 text-right text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Actions</th>
                            </tr>
                                    ...
                                    <td class="px-2.5 py-2.5 text-right text-xs whitespace-nowrap">
                                        <div class="flex items-center justify-end gap-1 whitespace-nowrap">
                                            <button @click="openPaySupplierDueModal(sup)"
                                                ...
                                                <span class="whitespace-nowrap">Pay Due</span>
                                            </button>
